...
oddFactorial num
  | num == 0 = 1
  | odd num = num * oddFactorial (num - 1)
  | otherwise = oddFactorial (num - 1)
...
countdown num = countdown' num num

countdown' :: Integer -> Integer -> String
countdown' initNum num
  | num == 0 = "Liftoff!"
  | num == initNum = "Ready! " ++ show num ++ "... " ++ countdown' initNum (num - 1)
  | otherwise = show num ++ "... " ++ countdown' initNum (num - 1)
...
smallestDivisor' num divisor
  | mod num divisor == 0 = divisor
  | otherwise = smallestDivisor' num (divisor + 1)
